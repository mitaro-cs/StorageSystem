...
на экране «Первый запуск» нажмите «Восстановить из резервной копии» — адрес сайта останется прежним.

Хотите работать попеременно на двух компьютерах (дома и в вузе)? «Настройки» → «Сервер» →
