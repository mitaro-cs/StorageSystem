...
- **Оформление под себя** (Профиль → Оформление): светлая, тёмная или как в системе и шесть цветов —
  Классика, Графит, Океан, Лес, Закат, Виноград.
...
сохранятся. Кнопка есть и в меню значка, и в «Настройки → Сервер → Состояние». У участников сайт
обновится при следующем открытии. Один раз, с версий 0.1.x на 0.2.0 и новее, установщик нужно скачать
вручную.
</details>
