...
- **Оформление под себя** (Профиль → Оформление): светлая, тёмная или как в системе, шесть цветов —
  Классика, Графит, Океан, Лес, Закат, Виноград — и стиль карточек: Обычный, Объём, Стекло или
  Цвет предметов.
...
| Модератор сайта | все группы | скрывать и удалять лишнее в новостях и комментариях; людей не блокирует и не исключает |
