...
пароль. Телефон или ноутбук спросит отпечаток, лицо или PIN-код. Теперь на странице входа достаточно
нажать «Войти по отпечатку или лицу». Ключ привязан к адресу сайта, поэтому работает на ссылке группы
(CloudPub, fxTunnel, свой домен), а не по IP-адресу. Если адрес сайта сменится, ключ нужно добавить
заново.
</details>
